...
<ol class="breadcrumb">
	...
	<li><a href="<?php echo $_SESSION['ruta3']?>">Gestionar Recursos</a></li>
	<li class="active">Modificar Recurso</li>
</ol>
	...
	<div class="panel panel-default">
		...
		<div class="panel-body">
			<ul class="list-group">
				...
				<li class="list-group-item">
					<h4>Modificar recurso</h4>
					</h2>
					</b><br>
					<form method="post"
						action="informacion_recurso_modificar.php?idRecurso=<?php echo $id_recurso?>"
						...
						<div class="form-group">
							<label for="visibilidad" class="col-lg-4 control-label">Visibilidad</label>
