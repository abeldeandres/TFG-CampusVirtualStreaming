...
$titulo_pagina = "CampusVirtual - Inicio Administrador";
...
<?php
	...
	$listaAsignaturas = obtenerTodasLasAsignaturas ( $id_usuario );
...
<div class="panel panel-primary">
	...
	<div class="panel-body">
		...
		$_SESSION ['ruta'] = 'listado_temas.php?idAsignatura=' . $asignatura ['id_asignatura'];
		?>
					<dt>
						<a
							href="listado_temas.php?idAsignatura=<?php echo $asignatura['id_asignatura'] ?>">Ver
							Temas</a>
					</dt>
				</dl>
			</li>
